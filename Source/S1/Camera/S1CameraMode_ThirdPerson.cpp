...
US1CameraMode_ThirdPerson::US1CameraMode_ThirdPerson()
{
	TargetOffsetCurve = nullptr;

	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(+00.0f, +00.0f, 0.0f), 1.00f, 1.00f, 14.f, 0));
	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(+00.0f, +16.0f, 0.0f), 0.75f, 0.75f, 00.f, 3));
	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(+00.0f, -16.0f, 0.0f), 0.75f, 0.75f, 00.f, 3));
	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(+00.0f, +32.0f, 0.0f), 0.50f, 0.50f, 00.f, 5));
	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(+00.0f, -32.0f, 0.0f), 0.50f, 0.50f, 00.f, 5));
	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(+20.0f, +00.0f, 0.0f), 1.00f, 1.00f, 00.f, 4));
	PenetrationAvoidanceFeelers.Add(FS1PenetrationAvoidanceFeeler(FRotator(-20.0f, +00.0f, 0.0f), 0.50f, 0.50f, 00.f, 4));
}
...
void US1CameraMode_ThirdPerson::UpdateForTarget(float DeltaTime)
{
...
void US1CameraMode_ThirdPerson::UpdatePreventPenetration(float DeltaTime)
{
	...
	const UPrimitiveComponent* PPActorRootComponent = Cast<UPrimitiveComponent>(TargetPawn->GetRootComponent());
	if (PPActorRootComponent)
	{
		...
		FVector SafeLocation = TargetPawn->GetActorLocation();
		...
		float const MaxHalfHeight = TargetPawn->GetSimpleCollisionHalfHeight() - PushInDistance;
		...
		PreventCameraPenetration(*TargetPawn, SafeLocation, View.Location, DeltaTime, AimLineToDesiredPosBlockedPct, bSingleRayPenetrationCheck);
...
void US1CameraMode_ThirdPerson::PreventCameraPenetration(class AActor const& ViewTarget, FVector const& SafeLoc, FVector& CameraLoc, float const& DeltaTime, float& DistBlockedPct, bool bSingleRayOnly)
{
	...
	{
		FS1PenetrationAvoidanceFeeler& Feeler = PenetrationAvoidanceFeelers[RayIdx];
...
void US1CameraMode_ThirdPerson::SetTargetCrouchOffset(FVector NewTargetOffset)
{
...
void US1CameraMode_ThirdPerson::UpdateCrouchOffset(float DeltaTime)
{
